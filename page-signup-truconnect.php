...
function validatePassword(fld) {
 ...
 //  var illegalChars = /[\W_]/; // allow only letters and numbers 
    ...
    if (fld.value == "" || !fld.value.match(num) || (fld.value.length > 20) || !fld.value.match(caps) ) {
        fld.style.background = 'Yellow';
...
<img src="<?php echo esc_url(get_template_directory_uri());; ?>/images/truconnect.png" style="margin:150px auto 0;width:80%;height:auto;display:block" >
...
<form id="theForm" name="theForm" method="POST" action="<?php echo esc_url(get_template_directory_uri());; ?>/page-process-truconnect.php" onKeyPress="checkForm()" onMouseMove="checkForm()">
<?php else: ?>
<form id="theForm" name="theForm" method="POST" action="<?php echo esc_url(get_template_directory_uri());; ?>/page-process-truconnectsp.php" onKeyPress="checkForm()" onMouseMove="checkForm()">
<?php endif; ?>
...
<?php endif; ?>
<p><input type="email" name="email" maxlength="50" id="email" onBlur="return validateEmail(this)" onKeyPress="return validateEmail(this)" autocomplete="off"></p>
