...
<!--HERO BANNER-->
<div class="landing">
<div class="container landinghero">

<div class="hero-banner">
<!-- IMAGE PLACEMENT -->

<button class="<?php the_field('cta-color'); ?>" onClick="window.location.href='<?php the_field('cta-url'); ?>'"><?php the_field('cta-btn-left');?></button>
</div>
</div>
<!--HERO BANNER-->
...
<?php if('cat=534&tag=' . $tag): ?>
	...
	<section id="greybnr"><div class="clearfix">
	<p>
	<?php the_field("cta"); ?>
	<button class="<?php the_field('cta-color'); ?>" onClick="window.location.href='<?php the_field('cta-btn-url'); ?>'" >
...
<!-- POPULAR SHOWS -->
 ...
 <p>
	<?php the_field("cta"); ?>
	<button class="<?php the_field('cta-color'); ?>" onClick="window.location.href='<?php the_field('cta-btn2-url'); ?>'">
