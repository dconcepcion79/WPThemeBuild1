...
if ($httpcode == '409' ){
	header("Location:" . $_SERVER['HTTP_REFERER'] . $_SERVER['PATH_INFO'] . "existe-usario/" );
}  
...
if ($httpcode == '200' ){
	header("Location:" . $_SERVER['HTTP_REFERER'] . $_SERVER['PATH_INFO'] . "bienvenido-a-tu-membresia-premier/" );
} 
